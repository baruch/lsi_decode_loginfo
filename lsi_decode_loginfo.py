...
pl_open_fail = ["Sub Code", 0x0000FFFF, {
0x00000100: ("PL_LOGINFO_SUB_CODE_OPEN_FAILURE", None, ""),
0x00000101: ("PL_LOGINFO_SUB_CODE_OPEN_FAILURE_NO_DEST_TIMEOUT", None, ""),
0x00000102: ("PL_LOGINFO_SUB_CODE_OPEN_FAILURE_SATA_NEG_RATE_2HI", None, ""),
0x00000103: ("PL_LOGINFO_SUB_CODE_OPEN_FAILURE_RATE_NOT_SUPPORTED", None, ""),
0x00000104: ("PL_LOGINFO_SUB_CODE_OPEN_FAILURE_BREAK", None, ""),
0x00000114: ("PL_LOGINFO_SUB_CODE_OPEN_FAILURE_ABANDON0", None, "Open Reject (Zone Violation) - available on SAS-2 devices"),
0x00000114: ("PL_LOGINFO_SUB_CODE_OPEN_FAILURE_ZONE_VIOLATION", None, ""),
0x00000115: ("PL_LOGINFO_SUB_CODE_OPEN_FAILURE_ABANDON1", None, ""),
0x00000116: ("PL_LOGINFO_SUB_CODE_OPEN_FAILURE_ABANDON2", None, ""),
0x00000117: ("PL_LOGINFO_SUB_CODE_OPEN_FAILURE_ABANDON3", None, ""),
0x0000011A: ("PL_LOGINFO_SUB_CODE_OPEN_FAILURE_ORR_TIMEOUT", None, "Open Reject (Retry) Timeout"),
0x0000011B: ("PL_LOGINFO_SUB_CODE_OPEN_FAILURE_PATH_BLOCKED", None, ""),
0x0000011C: ("PL_LOGINFO_SUB_CODE_OPEN_FAILURE_AWT_MAXED", None, "Arbitration Wait Timer Maxed"),
0x00000120: ("PL_LOGINFO_SUB_CODE_TARGET_BUS_RESET", None, ""),
0x00000130: ("PL_LOGINFO_SUB_CODE_TRANSPORT_LAYER", None, "Leave lower nibble (1-f) reserved."),
0x00000140: ("PL_LOGINFO_SUB_CODE_PORT_LAYER", None, "Leave lower nibble (1-f) reserved."),
...
0x00000E00: ("PL_LOGINFO_SUB_CODE_DISCOVERY_SATA_INIT_W_IOS", None, ""),
0x00000E01: ("PL_LOGINFO_SUB_CODE_DISCOVERY_REMOTE_SEP_RESET", None, ""),
